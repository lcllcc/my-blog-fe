...
function loadWidget(config) {
    ...
    document.body.insertAdjacentHTML("beforeend", `<div id="waifu">
            ...
            <div id="waifu-input-container">
                <input type="text" id="waifu-input" placeholder="请输入内容...">
                <button id="waifu-input-button">发送</button>
    ...
    // 注册监听事件
    console.log("注册waifu-input-button点击监听");
    const inputButton = document.getElementById(`waifu-input-button`);
    const input = document.getElementById(`waifu-input`);
    inputButton.addEventListener("click", () => channel.sendMessage(document.getElementById("waifu-input").value));
    input.addEventListener("keyup", function(event) {
        // 判断是否按下回车键
        if (event.key === "Enter") {
            channel.sendMessage(document.getElementById("waifu-input").value)
        }
      });
    ...
    (function initModel() {
        ...
        console.log('加载json配置文件', config.waifuPath)
